...
2. Open `https://your-host/` in an ordinary browser and press **Ask Proof** (bottom-left, on any page). The canonical ask is already in the box — send it → staged change at **$294, Room 418** → approve → the caught mismatch (**$319** charged). Asking again then stages the clean recovery (**Room 401, $247**), and approving that lands a green, fully-verified receipt. **Reset demo** (under the chat input) restores the canonical world at any time — use it before every rehearsal and before recording.
